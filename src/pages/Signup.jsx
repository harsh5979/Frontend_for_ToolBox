...
const Signup = () => {
  ...
  return (
    <div>
      <div className=" md:w-[30%] w-[97%] mx-2 md:my-12 border text-black  bg-[#f3f4f6] rounded-md my-8 p-5  h-full md:h-[500px] md:m-auto items-center justify-center text-center">
